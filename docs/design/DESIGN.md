...
| History view (U6, planned)               | `RunBoard`                                                 | Archive-aware history host: include-archived toggle, unarchive action, replay links into the existing run detail view; replaces the ephemeral "Clear view" state with the real archive lifecycle                                                                                                                                                                                                                                                                                                                       |
| Session lifecycle controls (U6, planned) | `FactoryCommandBar`                                        | New Session (arm/confirm pattern; the confirm names active runs and warns when deployed artifacts remain live) and Factory Reset (visually and semantically separated; typed confirmation rendering the server's pre-flight enumeration; reset-generation change renders a forced-reload banner)                                                                                                                                                                                                                       |
